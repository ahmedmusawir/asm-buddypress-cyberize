          ...
          <main class="">
            ...
            <div class="entry-meta pl-2 mb-5 row">
              <?php
							...
							?>
              <ul class="list-inline">Listing
                Category:<?php echo get_the_term_list( $post->ID, 'listing-category', '<li class="list-inline-item">', ', ', '</li>' ) ?>
              </ul>
              <ul class="list-inline">Listing
                Tag:<?php echo get_the_term_list( $post->ID, 'listing-tag', '<li class="list-inline-item">', ', ', '</li>' ) ?>
              </ul>
            </div><!-- .entry-meta -->
            <?php
						endif; ?>
